...
class Project extends Model {
    ...
    protected $fillable = [
        'plan_id', 'code', 'name_th', 'name_en', 'description',
        'project_type', 'fiscal_year', 'sort_order', 'is_active',
    ...
    {
        $result = Database::query("SELECT * FROM projects WHERE id = ?", [$id]);
        return $result[0] ?? null;
    }

    public static function where(string $column, $value): SimpleQueryBuilder
    {
        $builder = new SimpleQueryBuilder('projects');
