...
try {
    ...
    echo "Inserted Item ID: $newItemId\n";
    ...
    if ($ref) {
        ...
        echo "Inserted Budget Line Item for Org 3\n";
    } else {
        echo "Warning: Could not find reference budget line item for Item 40/Org 3. Mapping might be missing.\n";
    }
