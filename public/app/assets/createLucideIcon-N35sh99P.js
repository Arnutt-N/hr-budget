import{aj as v,ac as u,N as A}from"./index-D0UwyIn9.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const j=Symbol("lucide-icons");function $(){return v(j,{})}/**
 * @license @lucide/vue v1.17.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const E=({name:t,iconNode:e,absoluteStrokeWidth:r,"absolute-stroke-width":o,strokeWidth:c,"stroke-width":k,size:i,color:C,...f},{slots:l})=>{const{size:n,color:p,strokeWidth:m=2,absoluteStrokeWidth:g=!1,class:x=""}=$(),b=A(()=>{const a=h(r)||h(o)||r===!0||o===!0||g===!0,d=c||k||m||s["stroke-width"];return a?Number(d)*24/Number(i??n??s.width):d});return u("svg",{...s,...f,width:i??n??s.width,height:i??n??s.height,stroke:C??p??s.stroke,"stroke-width":b.value,class:S("lucide",x,...t?[`lucide-${w(W(t))}-icon`,`lucide-${w(t)}`]:["lucide-icon"])},[...e.map(a=>u(...a)),...l.default?[l.default()]:[]])};/**
 * @license @lucide/vue v1.17.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
